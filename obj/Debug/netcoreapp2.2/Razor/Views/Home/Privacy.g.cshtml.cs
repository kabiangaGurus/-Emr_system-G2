#pragma checksum "C:\Users\kili\source\repos\Group2\Group2\Views\Home\Privacy.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "94c6121742ab16ccc776535c6e2491e342ae0942"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"94c6121742ab16ccc776535c6e2491e342ae0942", @"/Views/Home/Privacy.cshtml")]
    ...
    public class Views_Home_Privacy : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "C:\Users\kili\source\repos\Group2\Group2\Views\Home\Privacy.cshtml"
  
    ViewData["Title"] = "Privacy Policy";

#line default
#line hidden
            BeginContext(50, 20709, true);
            WriteLiteral(@"
...
<p>Welcome to <b> HackertonProject</b>.</p>
<p><b>HackertonProject</b> (“us”, “we”, or “our”) operates <b>Group2Hackerton.com</b> (hereinafter referred to as <b>“Service”</b>).</p>
<p>Our Privacy Policy governs your visit to <b>Group2Hackerton.com</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
...
<p><b>SERVICE</b> means the Group2Hackerton.com website operated by Hackert");
            WriteLiteral(@"onProject.</p>
...
<p><b>DATA PROCESSORS (OR SERVICE PROVIDERS)</b> means any natural or legal person who processes the data on behalf of the Data Controller. We may use the services of various Service Providers in order to process your data");
            WriteLiteral(@" more effectively.</p> <p><b>DATA SUBJECT</b> is any living individual who is the subject of Personal Data.</p>
...
<p>We may use your Personal Data to contact you with newsletters, marketing or ");
            WriteLiteral(@"promotional materials and other information that may be of interest to you. You may opt out of receiving any, or all, of these communications from us by following the unsubscribe link.</p>
<p><b>Usage Data</b></p>
...
<p>Exam");
            WriteLiteral(@"ples of Cookies we use:</p>
...
<p><b>Other Data</b></p>
<p>While using our Service, we may also collect the following information: sex, age, date of birth, place of birth, passport details, citizenship, registration at place of residence and actual address, telephone number (work, mobile), details of documents on education, qualification, professional training, employment agreements, <a href=""emmanukiptoo98@gmail.com"">NDA agreements</a>, information on bonuses and compensation, information on marital status, family members, social security (or other taxpayer identification) number,");
            WriteLiteral(@" office location and other data.</p>
<p>5. <b>Use of Data</b></p>
<p>HackertonProject uses the collected data for various purposes:</p>
...
<p>0.11. to provide you with news, special off");
...
<p>We will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to");
            WriteLiteral(@" retain this data for longer time periods.</p>
...
<p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>emmanukiptoo98@gmail.com</b>.</p>
<p>In certain cir");
            WriteLiteral(@"cumstances, you have the following data protection rights:</p>
...
<p>Please note that we may ask you to verify your identity before responding to such requests. Please note, we may not able to provide Service without");
            WriteLiteral(@" some necessary data.</p>
...
<p>0.2. our Priva");
            WriteLiteral(@"cy Policy link includes the word “Privacy”, and can easily be found on the home page of our website;</p>
<p>0.3. users will be notified of any privacy policy changes on our Privacy Policy Page;</p>
<p>0.4. users are able to change their personal information by emailing us at <b>emmanukiptoo98@gmail.com</b>.</p>
...
<p>If you are a California resident, you are entitled to learn what data we collect about you, ask to delete your data and not to sell (share) it. To exercise your data protection rights, you can ");
            WriteLiteral(@"make certain requests and ask us:</p>
...
<p>Please note, you are entit");
            WriteLiteral(@"led to ask us to provide you with this information up to two times in a rolling twelve-month period. When you make this request, the information provided may be limited to the personal information we collected about you in the previous 12 months.</p>
...
<p><b>0.3. To stop selling your personal information. We don’t sell or rent your personal information to any third parties for any purpose. We do not sell your personal information for monetary consideration. However, under some circumstances, a transfer of personal information to a third party, ");
            WriteLiteral(@"or within our family of companies, without monetary consideration may be considered a “sale” under California law. You are the only owner of your Personal Data and can request disclosure or deletion at any time.</b></p>
<p>If you submit a request to stop selling your personal information, we will stop making such transfers.</p>
<p>Please note, if you ask us to delete or stop selling your data, it may impact your experience with us, and you may not be able to participate in certain programs or membership services which require the usage of your personal information to function. But in no circumstances, we will discriminate against you for exercising your rights.</p>
<p>To exercise your California data protection rights described above, please send your request(s) by email: <b>emmanukiptoo98@gmail.com</b>.</p>
<p>Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy Act. To find out more, visit the official California Legislative Information website");
            WriteLiteral(@". The CCPA took effect on 01/01/2020.</p>
...
<p>17. <b");
            WriteLiteral(@">Links to Other Sites</b></p>
<p>Our Service may contain links to other sites that are not operated by us. If you click a third party link, you will be directed to that third party’s site. We strongly advise you to review the Privacy Policy of every site you visit.</p>
<p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
<p>For example, the outlined <a href=""emmanukiptoo98@gmail.com"">privacy policy</a> has been made using <a href=""emmanukiptoo98@gmail.com"">PolicyMaker.io</a>, a free tool that helps create high-quality legal documents. PolicyMaker’s <a href=""https://policymaker.io/privacy-policy/"">privacy policy generator</a> is an easy-to-use tool for creating a <a href=""emmanukiptoo98@gmail.com"">privacy policy for blog</a>, website, e-commerce store or mobile app.</p>
<p>18. <b><b>Children’s Privacy</b></b></p>
<p>Our Services are not intended for use by children under the age of 18 (<b>“Child”</b> or <b>“Childre");
            WriteLiteral(@"n”</b>).</p>
...
<p>If you have any questions about this Privacy Policy, please contact us by email: <b");
            WriteLiteral(">emmanukiptoo98@gmail.com</b>.</p>\r\n<p style=\"margin-top: 5em; font-size: 0.7em;\">This Privacy Policy was created for <b>Group2Hackerton.com</b> by <a href=\"emmanukiptoo98@gmail.com\">PolicyMaker.io</a> on 2020-08-27.</p>\r\n.</p>\r\n");
            EndContext();
        }
